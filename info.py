...
BOT_TOKEN = environ.get('BOT_TOKEN', "6693659212:AAENeESni5XF_NVyl-w0xoHKxDjXcdFFu0k")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1792616064 885675538').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001840980505').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1792616064 885675538').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001653919318')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+2p5iD8xBxE43NzBl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Yessma_ullu_tamil_latest_webseri')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Yessma_ullu_tamil_latest_webseri')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', '𝐖𝐡𝐚𝐭 𝐀𝐫𝐞 𝐘𝐨𝐮 𝐋𝐨𝐨𝐤𝐢𝐧𝐠 𝐀 ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001542644178'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+2p5iD8xBxE43NzBl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001840980505')).split()]
